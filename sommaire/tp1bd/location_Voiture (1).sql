...
(12, 1000, 'Jamy', 'paris', '06', '1997-03-21', 'jamyjames@icloud.com'),
(13, 2000, 'Gisèle', 'créteil', '07 12', '1962-10-16', 'gisèle@gmail.com');
...
(2, '66 FR 66', 13, 4, '2024-10-11', 200);
...
CREATE TABLE IF NOT EXISTS `voitures` (
  ...
  `date circulation` date NOT NULL,
...
INSERT INTO `voitures` (`immatriculation`, `marque`, `modele`, `carburant`, `kilometrage`, `date circulation`, `couleur`) VALUES
('66 FR 66', 'Mercedes', 'GLC', 'Diesel', 10000, '2024-10-08', 'blanc'),
('77 FR 77', 'Audi', 'R8', 'Essence', 20000, '2019-10-10', 'rouge');
